...
SYSTEM_PROMPT_BASE = (
    "Ты — помощник для сотрудников компании. Отвечай ТОЛЬКО на основе предоставленного контекста. "
    "Если в контексте нет информации, скажи об этом. Указывай название документа-источника. "
    "Отвечай на русском языке. Не додумывай информацию."
)
...
def build_answer_system_prompt(response_length: str) -> str:
    ...
    return f"{SYSTEM_PROMPT_BASE} Сохраняй точность, ясность и полезность ответа. {instruction}"
