...
SYSTEM_PROMPT_BASE = """Ты — помощник для сотрудников компании. Твоя задача — отвечать на вопросы по регламентам и учебным материалам компании.
...
def build_answer_system_prompt(response_length: str) -> str:
    ...
    return f"{SYSTEM_PROMPT_BASE}\n\nСохраняй точность, ясность и полезность ответа. {instruction}"
